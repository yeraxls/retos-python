...
text_numeric = [character for character in text if character.isnumeric()]
print(text_numeric)
sum = 0
for i in range(0,len(text_numeric),2):
    print(f"{text_numeric[i]}{text_numeric[i+1]}")
    sum = sum + int(f"{text_numeric[i]}{text_numeric[i+1]}")
